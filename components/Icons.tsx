...
export const RoadIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M4 19l4-14"/><path d="M16 5l4 14"/><path d="M12 8v4"/><path d="M12 16v2"/>
    </svg>
);
...
export const SparklesIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m12 3-1.9 3.9-3.9 1.9 3.9 1.9 1.9 3.9 1.9-3.9 3.9-1.9-3.9-1.9Z"/><path d="M5 22s1.5-2 4-2 4 2 4 2"/><path d="M15 22s1.5-2 4-2 4 2 4 2"/><path d="M3 10.5s1.5-2 4-2 4 2 4 2"/><path d="M13 10.5s1.5-2 4-2 4 2 4 2"/>
    </svg>
);
...
export const FuelPumpIcon = ({ size = 64, className = '' }: { size?: number; className?: string }) => (
    <svg 
        ...
        className={className}
    >
        <path d="M3 2v14h3v-2a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2h3V2Z"></path>
        <path d="M14 2v4h-4"></path>
        <path d="M18 14h-5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h5Z"></path>
        <path d="M21 14v1a2 2 0 0 1-2 2h-2"></path>
    </svg>
);
